System.register(["@angular/core", "@angular/router", "./clothes", "./clothes.service"], function (exports_1, context_1) {
    "use strict";
    ...
    var core_1, router_1, clothes_1, clothes_service_1, ClothesDetailComponent;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function () {
            ClothesDetailComponent = class ClothesDetailComponent {
                ...
                ngOnInit() {
                    ...
                    //    let id = +params['id'];
                    //    this.clothesService.getClothesItem(id).subscribe(clothesItem => this.clothesItem = clothesItem);
                    //});
            ...
            <div *ngIf="clothesItem" class="item-details">
                ...
                <ul>
                    <li>
                        ...
                        <select id="category" required [(ngModel)]="type">
