    ...
    return {
        ...
        execute: function () {
            ...
            AppModule = __decorate([
                core_1.NgModule({
                    declarations: [app_component_1.AppComponent, clothes_list_component_1.ClothesListComponent, clothes_detail_view_component_1.ClothesDetailViewComponent, clothes_detail_edit_component_1.ClothesDetailEditComponent, clothes_grid_component_1.ClothesGridComponent, home_component_1.HomeComponent, log_item_component_1.LogItemComponent, view_history_component_1.ViewHistoryComponent, clothes_pipe_1.TransformCategoryPipe, clothes_pipe_2.TransformDatePipe],
                    ...
                    providers: [clothes_service_1.ClothesService, history_service_1.HistoryService],
