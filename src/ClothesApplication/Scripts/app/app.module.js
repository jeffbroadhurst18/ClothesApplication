System.register(["@angular/core", "@angular/platform-browser", "@angular/http", "./app-routing", "rxjs/Rx", "@angular/forms", "@angular/router", "./app.component", "./clothes-list.component", "./clothes-detail-view.component", "./clothes-detail-edit.component", "./clothes-grid.component", "./log-item.component", "./home.component", "./view-history.component", "./filtered-history.component", "./clothes.service", "./history.service", "./pager.service", "./clothes-pipe"], function (exports_1, context_1) {
    ...
    var core_1, platform_browser_1, http_1, app_routing_1, forms_1, router_1, app_component_1, clothes_list_component_1, clothes_detail_view_component_1, clothes_detail_edit_component_1, clothes_grid_component_1, log_item_component_1, home_component_1, view_history_component_1, filtered_history_component_1, clothes_service_1, history_service_1, pager_service_1, clothes_pipe_1, clothes_pipe_2, AppModule;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
            ...
            AppModule = __decorate([
                core_1.NgModule({
                    declarations: [app_component_1.AppComponent, clothes_list_component_1.ClothesListComponent, clothes_detail_view_component_1.ClothesDetailViewComponent,
                        ...
                        view_history_component_1.ViewHistoryComponent, filtered_history_component_1.FilteredHistoryComponent, clothes_pipe_1.TransformCategoryPipe, clothes_pipe_2.TransformDatePipe],
                    ...
                    providers: [clothes_service_1.ClothesService, history_service_1.HistoryService, pager_service_1.PagerService],
